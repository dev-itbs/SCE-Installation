...
if defined DIR_VAULT (
    ...
    (
        ...
        echo PGPOOL_EXTERNAL_PG_PRIMARY=
        echo PGPOOL_EXTERNAL_PG_PRIMARY_PORT=
        ...
        echo.
        echo # Optional object-storage-to-object-storage backup.
        echo OBJECT_BACKUP_ENABLED=false
        echo OBJECT_BACKUP_INTERVAL_SECONDS=300
        echo OBJECT_BACKUP_BATCH_SIZE=100
        echo OBJECT_BACKUP_SOURCE_ENDPOINT=
        echo OBJECT_BACKUP_SOURCE_REGION=us-east-1
        echo OBJECT_BACKUP_SOURCE_BUCKET=
        echo OBJECT_BACKUP_SOURCE_PREFIX=
        echo OBJECT_BACKUP_SOURCE_ACCESS_KEY_ID=
        echo OBJECT_BACKUP_SOURCE_SECRET_ACCESS_KEY=
        echo OBJECT_BACKUP_SOURCE_FORCE_PATH_STYLE=true
        echo OBJECT_BACKUP_TARGET_ENDPOINT=
        echo OBJECT_BACKUP_TARGET_REGION=us-east-1
        echo OBJECT_BACKUP_TARGET_BUCKET=
        echo OBJECT_BACKUP_TARGET_PREFIX=
        echo OBJECT_BACKUP_TARGET_ACCESS_KEY_ID=
        echo OBJECT_BACKUP_TARGET_SECRET_ACCESS_KEY=
        echo OBJECT_BACKUP_TARGET_FORCE_PATH_STYLE=true
    ) > "!_f!"
    echo   [OK] Written: !_f!
)
...
if defined DIR_PHP (
    ...
    (
        echo # Generated by SCE configure.bat
        echo.
        echo # Host port mapping (change if 8880 is already in use)
        echo PHP_HOST_PORT=!PHP_HOST_PORT!
        echo.
        echo # Database
